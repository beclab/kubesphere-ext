...
var promQLTemplates = map[string]string{
	...
	"cluster_disk_size_usage":        `sum(max(node_filesystem_size_bytes{device=~"/dev/.*", device!~"/dev/loop\\d+", job="node-exporter"} - node_filesystem_avail_bytes{device=~"/dev/.*", device!~"/dev/loop\\d+", job="node-exporter"}) by (device, instance)) - (sum(max(label_replace(node_filesystem_size_bytes{device=~"/dev/.*", device!~"/dev/loop\\d+", job="node-exporter"} - node_filesystem_avail_bytes{device=~"/dev/.*", device!~"/dev/loop\\d+", job="node-exporter"}, "base_device", "$1", "device", "/dev/(nvme\\d+n\\d+|mmcblk\\d+|[a-z]+)p?\\d*") and on (instance, base_device) label_replace(node_disk_info{external="1"}, "base_device", "$1", "device", "(.*)")) by (device, instance)) or vector(0))`,
	...
	"cluster_disk_size_available":    `sum(max(node_filesystem_avail_bytes{device=~"/dev/.*", device!~"/dev/loop\\d+", job="node-exporter"}) by (device, instance)) - (sum(max(label_replace(node_filesystem_avail_bytes{device=~"/dev/.*", device!~"/dev/loop\\d+", job="node-exporter"}, "base_device", "$1", "device", "/dev/(nvme\\d+n\\d+|mmcblk\\d+|[a-z]+)p?\\d*") and on (instance, base_device) label_replace(node_disk_info{external="1"}, "base_device", "$1", "device", "(.*)")) by (device, instance)) or vector(0))`,
	...
	// amd gpu
	"cluster_amd_gpu_average_package_power":   `amd_gpu_average_package_power`,
	"cluster_amd_gpu_clock":                   `amd_gpu_clock`,
	"cluster_amd_gpu_ecc_correct_athub":       `amd_gpu_ecc_correct_athub`,
	"cluster_amd_gpu_ecc_correct_bif":         `amd_gpu_ecc_correct_bif`,
	"cluster_amd_gpu_ecc_correct_df":          `amd_gpu_ecc_correct_df`,
	"cluster_amd_gpu_ecc_correct_fuse":        `amd_gpu_ecc_correct_fuse`,
	"cluster_amd_gpu_ecc_correct_gfx":         `amd_gpu_ecc_correct_gfx`,
	"cluster_amd_gpu_ecc_correct_hdp":         `amd_gpu_ecc_correct_hdp`,
	"cluster_amd_gpu_ecc_correct_ih":          `amd_gpu_ecc_correct_ih`,
	"cluster_amd_gpu_ecc_correct_jpeg":        `amd_gpu_ecc_correct_jpeg`,
	"cluster_amd_gpu_ecc_correct_mca":         `amd_gpu_ecc_correct_mca`,
	"cluster_amd_gpu_ecc_correct_mmhub":       `amd_gpu_ecc_correct_mmhub`,
	"cluster_amd_gpu_ecc_correct_mp0":         `amd_gpu_ecc_correct_mp0`,
	"cluster_amd_gpu_ecc_correct_mp1":         `amd_gpu_ecc_correct_mp1`,
	"cluster_amd_gpu_ecc_correct_mpio":        `amd_gpu_ecc_correct_mpio`,
	"cluster_amd_gpu_ecc_correct_sdma":        `amd_gpu_ecc_correct_sdma`,
	"cluster_amd_gpu_ecc_correct_sem":         `amd_gpu_ecc_correct_sem`,
	"cluster_amd_gpu_ecc_correct_smn":         `amd_gpu_ecc_correct_smn`,
	"cluster_amd_gpu_ecc_correct_total":       `amd_gpu_ecc_correct_total`,
	"cluster_amd_gpu_ecc_correct_umc":         `amd_gpu_ecc_correct_umc`,
	"cluster_amd_gpu_ecc_correct_vcn":         `amd_gpu_ecc_correct_vcn`,
	"cluster_amd_gpu_ecc_correct_xgmi_wafl":   `amd_gpu_ecc_correct_xgmi_wafl`,
	"cluster_amd_gpu_ecc_deferred_athub":      `amd_gpu_ecc_deferred_athub`,
	"cluster_amd_gpu_ecc_deferred_bif":        `amd_gpu_ecc_deferred_bif`,
	"cluster_amd_gpu_ecc_deferred_df":         `amd_gpu_ecc_deferred_df`,
	"cluster_amd_gpu_ecc_deferred_fuse":       `amd_gpu_ecc_deferred_fuse`,
	"cluster_amd_gpu_ecc_deferred_gfx":        `amd_gpu_ecc_deferred_gfx`,
	"cluster_amd_gpu_ecc_deferred_hdp":        `amd_gpu_ecc_deferred_hdp`,
	"cluster_amd_gpu_ecc_deferred_ih":         `amd_gpu_ecc_deferred_ih`,
	"cluster_amd_gpu_ecc_deferred_jpeg":       `amd_gpu_ecc_deferred_jpeg`,
	"cluster_amd_gpu_ecc_deferred_mca":        `amd_gpu_ecc_deferred_mca`,
	"cluster_amd_gpu_ecc_deferred_mmhub":      `amd_gpu_ecc_deferred_mmhub`,
	"cluster_amd_gpu_ecc_deferred_mp0":        `amd_gpu_ecc_deferred_mp0`,
	"cluster_amd_gpu_ecc_deferred_mp1":        `amd_gpu_ecc_deferred_mp1`,
	"cluster_amd_gpu_ecc_deferred_mpio":       `amd_gpu_ecc_deferred_mpio`,
	"cluster_amd_gpu_ecc_deferred_sdma":       `amd_gpu_ecc_deferred_sdma`,
	"cluster_amd_gpu_ecc_deferred_sem":        `amd_gpu_ecc_deferred_sem`,
	"cluster_amd_gpu_ecc_deferred_smn":        `amd_gpu_ecc_deferred_smn`,
	"cluster_amd_gpu_ecc_deferred_total":      `amd_gpu_ecc_deferred_total`,
	"cluster_amd_gpu_ecc_deferred_umc":        `amd_gpu_ecc_deferred_umc`,
	"cluster_amd_gpu_ecc_deferred_vcn":        `amd_gpu_ecc_deferred_vcn`,
	"cluster_amd_gpu_ecc_deferred_xgmi_wafl":  `amd_gpu_ecc_deferred_xgmi_wafl`,
	"cluster_amd_gpu_ecc_uncorrect_athub":     `amd_gpu_ecc_uncorrect_athub`,
	"cluster_amd_gpu_ecc_uncorrect_bif":       `amd_gpu_ecc_uncorrect_bif`,
	"cluster_amd_gpu_ecc_uncorrect_df":        `amd_gpu_ecc_uncorrect_df`,
	"cluster_amd_gpu_ecc_uncorrect_fuse":      `amd_gpu_ecc_uncorrect_fuse`,
	"cluster_amd_gpu_ecc_uncorrect_gfx":       `amd_gpu_ecc_uncorrect_gfx`,
	"cluster_amd_gpu_ecc_uncorrect_hdp":       `amd_gpu_ecc_uncorrect_hdp`,
	"cluster_amd_gpu_ecc_uncorrect_ih":        `amd_gpu_ecc_uncorrect_ih`,
	"cluster_amd_gpu_ecc_uncorrect_jpeg":      `amd_gpu_ecc_uncorrect_jpeg`,
	"cluster_amd_gpu_ecc_uncorrect_mca":       `amd_gpu_ecc_uncorrect_mca`,
	"cluster_amd_gpu_ecc_uncorrect_mmhub":     `amd_gpu_ecc_uncorrect_mmhub`,
	"cluster_amd_gpu_ecc_uncorrect_mp0":       `amd_gpu_ecc_uncorrect_mp0`,
	"cluster_amd_gpu_ecc_uncorrect_mp1":       `amd_gpu_ecc_uncorrect_mp1`,
	"cluster_amd_gpu_ecc_uncorrect_mpio":      `amd_gpu_ecc_uncorrect_mpio`,
	"cluster_amd_gpu_ecc_uncorrect_sdma":      `amd_gpu_ecc_uncorrect_sdma`,
	"cluster_amd_gpu_ecc_uncorrect_sem":       `amd_gpu_ecc_uncorrect_sem`,
	"cluster_amd_gpu_ecc_uncorrect_smn":       `amd_gpu_ecc_uncorrect_smn`,
	"cluster_amd_gpu_ecc_uncorrect_total":     `amd_gpu_ecc_uncorrect_total`,
	"cluster_amd_gpu_ecc_uncorrect_umc":       `amd_gpu_ecc_uncorrect_umc`,
	"cluster_amd_gpu_ecc_uncorrect_vcn":       `amd_gpu_ecc_uncorrect_vcn`,
	"cluster_amd_gpu_ecc_uncorrect_xgmi_wafl": `amd_gpu_ecc_uncorrect_xgmi_wafl`,
	"cluster_amd_gpu_edge_temperature":        `amd_gpu_edge_temperature`,
	"cluster_amd_gpu_free_gtt":                `amd_gpu_free_gtt`,
	"cluster_amd_gpu_free_visible_vram":       `amd_gpu_free_visible_vram`,
	"cluster_amd_gpu_free_vram":               `amd_gpu_free_vram`,
	"cluster_amd_gpu_gfx_activity":            `amd_gpu_gfx_activity`,
	"cluster_amd_gpu_gfx_voltage":             `amd_gpu_gfx_voltage`,
	"cluster_amd_gpu_health":                  `amd_gpu_health`,
	"cluster_amd_gpu_junction_temperature":    `amd_gpu_junction_temperature`,
	"cluster_amd_gpu_max_clock":               `amd_gpu_max_clock`,
	"cluster_amd_gpu_memory_temperature":      `amd_gpu_memory_temperature`,
	"cluster_amd_gpu_memory_voltage":          `amd_gpu_memory_voltage`,
	"cluster_amd_gpu_min_clock":               `amd_gpu_min_clock`,
	"cluster_amd_gpu_mma_activity":            `amd_gpu_mma_activity`,
	"cluster_amd_gpu_nodes_total":             `amd_gpu_nodes_total`,
	"cluster_amd_gpu_total_gtt":               `amd_gpu_total_gtt`,
	"cluster_amd_gpu_total_visible_vram":      `amd_gpu_total_visible_vram`,
	"cluster_amd_gpu_total_vram":              `amd_gpu_total_vram`,
	"cluster_amd_gpu_umc_activity":            `amd_gpu_umc_activity`,
	"cluster_amd_gpu_used_gtt":                `amd_gpu_used_gtt`,
	"cluster_amd_gpu_used_visible_vram":       `amd_gpu_used_visible_vram`,
	"cluster_amd_gpu_used_vram":               `amd_gpu_used_vram`,
	"cluster_amd_gpu_vcn_activity":            `amd_gpu_vcn_activity`,
	"cluster_amd_gpu_voltage":                 `amd_gpu_voltage`,
	"cluster_amd_gpu_xgmi_nbr_0_beats_tx":     `amd_gpu_xgmi_nbr_0_beats_tx`,
	"cluster_amd_gpu_xgmi_nbr_0_nop_tx":       `amd_gpu_xgmi_nbr_0_nop_tx`,
	"cluster_amd_gpu_xgmi_nbr_0_req_tx":       `amd_gpu_xgmi_nbr_0_req_tx`,
	"cluster_amd_gpu_xgmi_nbr_0_resp_tx":      `amd_gpu_xgmi_nbr_0_resp_tx`,
	"cluster_amd_gpu_xgmi_nbr_0_tx_thrput":    `amd_gpu_xgmi_nbr_0_tx_thrput`,
	"cluster_amd_gpu_xgmi_nbr_1_beats_tx":     `amd_gpu_xgmi_nbr_1_beats_tx`,
	"cluster_amd_gpu_xgmi_nbr_1_nop_tx":       `amd_gpu_xgmi_nbr_1_nop_tx`,
	"cluster_amd_gpu_xgmi_nbr_1_req_tx":       `amd_gpu_xgmi_nbr_1_req_tx`,
	"cluster_amd_gpu_xgmi_nbr_1_resp_tx":      `amd_gpu_xgmi_nbr_1_resp_tx`,
	"cluster_amd_gpu_xgmi_nbr_1_tx_thrput":    `amd_gpu_xgmi_nbr_1_tx_thrput`,
	"cluster_amd_gpu_xgmi_nbr_2_tx_thrput":    `amd_gpu_xgmi_nbr_2_tx_thrput`,
	"cluster_amd_gpu_xgmi_nbr_3_tx_thrput":    `amd_gpu_xgmi_nbr_3_tx_thrput`,
	"cluster_amd_gpu_xgmi_nbr_4_tx_thrput":    `amd_gpu_xgmi_nbr_4_tx_thrput`,
	"cluster_amd_gpu_xgmi_nbr_5_tx_thrput":    `amd_gpu_xgmi_nbr_5_tx_thrput`,
	"cluster_amd_pcie_max_speed":              `amd_pcie_max_speed`,
	"cluster_amd_pcie_speed":                  `amd_pcie_speed`,
	...
	"node_disk_size_capacity":     `sum(max(label_replace(node_filesystem_size_bytes{device=~"/dev/.*", device!~"/dev/loop\\d+", job="node-exporter"} * on (namespace, pod) group_left(node) node_namespace_pod:kube_pod_info:{$1}, "base_device", "${1}", "device", "/dev/(nvme\\d+n\\d+|mmcblk\\d+|[a-z]+)p?\\d*") unless on (instance, base_device) label_replace(node_disk_info{external="1"}, "base_device", "${1}", "device", "(.*)")) by (device, node)) by (node)`,
	"node_disk_size_available":    `node:disk_space_available:{$1}`,
	"node_disk_size_usage":        `sum(max(label_replace((node_filesystem_size_bytes{device=~"/dev/.*", device!~"/dev/loop\\d+", job="node-exporter"} - node_filesystem_avail_bytes{device=~"/dev/.*", device!~"/dev/loop\\d+", job="node-exporter"}) * on (namespace, pod) group_left(node) node_namespace_pod:kube_pod_info:{$1}, "base_device", "${1}", "device", "/dev/(nvme\\d+n\\d+|mmcblk\\d+|[a-z]+)p?\\d*") unless on (instance, base_device) label_replace(node_disk_info{external="1"}, "base_device", "${1}", "device", "(.*)")) by (device, node)) by (node)`,
	...
	"node_acpitz_temp_celsius":          `node:node_acpitz_temp_celsius{$1}`,
	...
	"node_cpu_frequency_max_hertz":      `node:node_cpu_frequency_max_hertz{$1}`,
	...
	"node_cpu_dmidecode_info":           `node:node_cpu_dmidecode_info{$1}`,
	...
	"node_device_size_usage":           `sum by(device, node, role) (label_replace(node_filesystem_size_bytes{device!~"/dev/loop\\d+",device=~"/dev/.*",job="node-exporter"} * on(namespace, pod) group_left(node, role) node_namespace_pod:kube_pod_info:{$1}, "base_device", "${1}", "device", "/dev/(nvme\\d+n\\d+|mmcblk\\d+|[a-z]+)p?\\d*") unless on (instance, base_device) label_replace(node_disk_info{external="1"}, "base_device", "${1}", "device", "(.*)")) - sum by(device, node, role) (label_replace(node_filesystem_avail_bytes{device!~"/dev/loop\\d+",device=~"/dev/.*",job="node-exporter"} * on(namespace, pod) group_left(node, role) node_namespace_pod:kube_pod_info:{$1}, "base_device", "${1}", "device", "/dev/(nvme\\d+n\\d+|mmcblk\\d+|[a-z]+)p?\\d*") unless on (instance, base_device) label_replace(node_disk_info{external="1"}, "base_device", "${1}", "device", "(.*)"))`,
	...
	// amd gpu
	"node_amd_gpu_average_package_power":   `amd_gpu_average_package_power{$1}`,
	"node_amd_gpu_clock":                   `amd_gpu_clock{$1}`,
	"node_amd_gpu_ecc_correct_athub":       `amd_gpu_ecc_correct_athub{$1}`,
	"node_amd_gpu_ecc_correct_bif":         `amd_gpu_ecc_correct_bif{$1}`,
	"node_amd_gpu_ecc_correct_df":          `amd_gpu_ecc_correct_df{$1}`,
	"node_amd_gpu_ecc_correct_fuse":        `amd_gpu_ecc_correct_fuse{$1}`,
	"node_amd_gpu_ecc_correct_gfx":         `amd_gpu_ecc_correct_gfx{$1}`,
	"node_amd_gpu_ecc_correct_hdp":         `amd_gpu_ecc_correct_hdp{$1}`,
	"node_amd_gpu_ecc_correct_ih":          `amd_gpu_ecc_correct_ih{$1}`,
	"node_amd_gpu_ecc_correct_jpeg":        `amd_gpu_ecc_correct_jpeg{$1}`,
	"node_amd_gpu_ecc_correct_mca":         `amd_gpu_ecc_correct_mca{$1}`,
	"node_amd_gpu_ecc_correct_mmhub":       `amd_gpu_ecc_correct_mmhub{$1}`,
	"node_amd_gpu_ecc_correct_mp0":         `amd_gpu_ecc_correct_mp0{$1}`,
	"node_amd_gpu_ecc_correct_mp1":         `amd_gpu_ecc_correct_mp1{$1}`,
	"node_amd_gpu_ecc_correct_mpio":        `amd_gpu_ecc_correct_mpio{$1}`,
	"node_amd_gpu_ecc_correct_sdma":        `amd_gpu_ecc_correct_sdma{$1}`,
	"node_amd_gpu_ecc_correct_sem":         `amd_gpu_ecc_correct_sem{$1}`,
	"node_amd_gpu_ecc_correct_smn":         `amd_gpu_ecc_correct_smn{$1}`,
	"node_amd_gpu_ecc_correct_total":       `amd_gpu_ecc_correct_total{$1}`,
	"node_amd_gpu_ecc_correct_umc":         `amd_gpu_ecc_correct_umc{$1}`,
	"node_amd_gpu_ecc_correct_vcn":         `amd_gpu_ecc_correct_vcn{$1}`,
	"node_amd_gpu_ecc_correct_xgmi_wafl":   `amd_gpu_ecc_correct_xgmi_wafl{$1}`,
	"node_amd_gpu_ecc_deferred_athub":      `amd_gpu_ecc_deferred_athub{$1}`,
	"node_amd_gpu_ecc_deferred_bif":        `amd_gpu_ecc_deferred_bif{$1}`,
	"node_amd_gpu_ecc_deferred_df":         `amd_gpu_ecc_deferred_df{$1}`,
	"node_amd_gpu_ecc_deferred_fuse":       `amd_gpu_ecc_deferred_fuse{$1}`,
	"node_amd_gpu_ecc_deferred_gfx":        `amd_gpu_ecc_deferred_gfx{$1}`,
	"node_amd_gpu_ecc_deferred_hdp":        `amd_gpu_ecc_deferred_hdp{$1}`,
	"node_amd_gpu_ecc_deferred_ih":         `amd_gpu_ecc_deferred_ih{$1}`,
	"node_amd_gpu_ecc_deferred_jpeg":       `amd_gpu_ecc_deferred_jpeg{$1}`,
	"node_amd_gpu_ecc_deferred_mca":        `amd_gpu_ecc_deferred_mca{$1}`,
	"node_amd_gpu_ecc_deferred_mmhub":      `amd_gpu_ecc_deferred_mmhub{$1}`,
	"node_amd_gpu_ecc_deferred_mp0":        `amd_gpu_ecc_deferred_mp0{$1}`,
	"node_amd_gpu_ecc_deferred_mp1":        `amd_gpu_ecc_deferred_mp1{$1}`,
	"node_amd_gpu_ecc_deferred_mpio":       `amd_gpu_ecc_deferred_mpio{$1}`,
	"node_amd_gpu_ecc_deferred_sdma":       `amd_gpu_ecc_deferred_sdma{$1}`,
	"node_amd_gpu_ecc_deferred_sem":        `amd_gpu_ecc_deferred_sem{$1}`,
	"node_amd_gpu_ecc_deferred_smn":        `amd_gpu_ecc_deferred_smn{$1}`,
	"node_amd_gpu_ecc_deferred_total":      `amd_gpu_ecc_deferred_total{$1}`,
	"node_amd_gpu_ecc_deferred_umc":        `amd_gpu_ecc_deferred_umc{$1}`,
	"node_amd_gpu_ecc_deferred_vcn":        `amd_gpu_ecc_deferred_vcn{$1}`,
	"node_amd_gpu_ecc_deferred_xgmi_wafl":  `amd_gpu_ecc_deferred_xgmi_wafl{$1}`,
	"node_amd_gpu_ecc_uncorrect_athub":     `amd_gpu_ecc_uncorrect_athub{$1}`,
	"node_amd_gpu_ecc_uncorrect_bif":       `amd_gpu_ecc_uncorrect_bif{$1}`,
	"node_amd_gpu_ecc_uncorrect_df":        `amd_gpu_ecc_uncorrect_df{$1}`,
	"node_amd_gpu_ecc_uncorrect_fuse":      `amd_gpu_ecc_uncorrect_fuse{$1}`,
	"node_amd_gpu_ecc_uncorrect_gfx":       `amd_gpu_ecc_uncorrect_gfx{$1}`,
	"node_amd_gpu_ecc_uncorrect_hdp":       `amd_gpu_ecc_uncorrect_hdp{$1}`,
	"node_amd_gpu_ecc_uncorrect_ih":        `amd_gpu_ecc_uncorrect_ih{$1}`,
	"node_amd_gpu_ecc_uncorrect_jpeg":      `amd_gpu_ecc_uncorrect_jpeg{$1}`,
	"node_amd_gpu_ecc_uncorrect_mca":       `amd_gpu_ecc_uncorrect_mca{$1}`,
	"node_amd_gpu_ecc_uncorrect_mmhub":     `amd_gpu_ecc_uncorrect_mmhub{$1}`,
	"node_amd_gpu_ecc_uncorrect_mp0":       `amd_gpu_ecc_uncorrect_mp0{$1}`,
	"node_amd_gpu_ecc_uncorrect_mp1":       `amd_gpu_ecc_uncorrect_mp1{$1}`,
	"node_amd_gpu_ecc_uncorrect_mpio":      `amd_gpu_ecc_uncorrect_mpio{$1}`,
	"node_amd_gpu_ecc_uncorrect_sdma":      `amd_gpu_ecc_uncorrect_sdma{$1}`,
	"node_amd_gpu_ecc_uncorrect_sem":       `amd_gpu_ecc_uncorrect_sem{$1}`,
	"node_amd_gpu_ecc_uncorrect_smn":       `amd_gpu_ecc_uncorrect_smn{$1}`,
	"node_amd_gpu_ecc_uncorrect_total":     `amd_gpu_ecc_uncorrect_total{$1}`,
	"node_amd_gpu_ecc_uncorrect_umc":       `amd_gpu_ecc_uncorrect_umc{$1}`,
	"node_amd_gpu_ecc_uncorrect_vcn":       `amd_gpu_ecc_uncorrect_vcn{$1}`,
	"node_amd_gpu_ecc_uncorrect_xgmi_wafl": `amd_gpu_ecc_uncorrect_xgmi_wafl{$1}`,
	"node_amd_gpu_edge_temperature":        `amd_gpu_edge_temperature{$1}`,
	"node_amd_gpu_free_gtt":                `amd_gpu_free_gtt{$1}`,
	"node_amd_gpu_free_visible_vram":       `amd_gpu_free_visible_vram{$1}`,
	"node_amd_gpu_free_vram":               `amd_gpu_free_vram{$1}`,
	"node_amd_gpu_gfx_activity":            `amd_gpu_gfx_activity{$1}`,
	"node_amd_gpu_gfx_voltage":             `amd_gpu_gfx_voltage{$1}`,
	"node_amd_gpu_health":                  `amd_gpu_health{$1}`,
	"node_amd_gpu_junction_temperature":    `amd_gpu_junction_temperature{$1}`,
	"node_amd_gpu_max_clock":               `amd_gpu_max_clock{$1}`,
	"node_amd_gpu_memory_temperature":      `amd_gpu_memory_temperature{$1}`,
	"node_amd_gpu_memory_voltage":          `amd_gpu_memory_voltage{$1}`,
	"node_amd_gpu_min_clock":               `amd_gpu_min_clock{$1}`,
	"node_amd_gpu_mma_activity":            `amd_gpu_mma_activity{$1}`,
	"node_amd_gpu_nodes_total":             `amd_gpu_nodes_total{$1}`,
	"node_amd_gpu_total_gtt":               `amd_gpu_total_gtt{$1}`,
	"node_amd_gpu_total_visible_vram":      `amd_gpu_total_visible_vram{$1}`,
	"node_amd_gpu_total_vram":              `amd_gpu_total_vram{$1}`,
	"node_amd_gpu_umc_activity":            `amd_gpu_umc_activity{$1}`,
	"node_amd_gpu_used_gtt":                `amd_gpu_used_gtt{$1}`,
	"node_amd_gpu_used_visible_vram":       `amd_gpu_used_visible_vram{$1}`,
	"node_amd_gpu_used_vram":               `amd_gpu_used_vram{$1}`,
	"node_amd_gpu_vcn_activity":            `amd_gpu_vcn_activity{$1}`,
	"node_amd_gpu_voltage":                 `amd_gpu_voltage{$1}`,
	"node_amd_gpu_xgmi_nbr_0_beats_tx":     `amd_gpu_xgmi_nbr_0_beats_tx{$1}`,
	"node_amd_gpu_xgmi_nbr_0_nop_tx":       `amd_gpu_xgmi_nbr_0_nop_tx{$1}`,
	"node_amd_gpu_xgmi_nbr_0_req_tx":       `amd_gpu_xgmi_nbr_0_req_tx{$1}`,
	"node_amd_gpu_xgmi_nbr_0_resp_tx":      `amd_gpu_xgmi_nbr_0_resp_tx{$1}`,
	"node_amd_gpu_xgmi_nbr_0_tx_thrput":    `amd_gpu_xgmi_nbr_0_tx_thrput{$1}`,
	"node_amd_gpu_xgmi_nbr_1_beats_tx":     `amd_gpu_xgmi_nbr_1_beats_tx{$1}`,
	"node_amd_gpu_xgmi_nbr_1_nop_tx":       `amd_gpu_xgmi_nbr_1_nop_tx{$1}`,
	"node_amd_gpu_xgmi_nbr_1_req_tx":       `amd_gpu_xgmi_nbr_1_req_tx{$1}`,
	"node_amd_gpu_xgmi_nbr_1_resp_tx":      `amd_gpu_xgmi_nbr_1_resp_tx{$1}`,
	"node_amd_gpu_xgmi_nbr_1_tx_thrput":    `amd_gpu_xgmi_nbr_1_tx_thrput{$1}`,
	"node_amd_gpu_xgmi_nbr_2_tx_thrput":    `amd_gpu_xgmi_nbr_2_tx_thrput{$1}`,
	"node_amd_gpu_xgmi_nbr_3_tx_thrput":    `amd_gpu_xgmi_nbr_3_tx_thrput{$1}`,
	"node_amd_gpu_xgmi_nbr_4_tx_thrput":    `amd_gpu_xgmi_nbr_4_tx_thrput{$1}`,
	"node_amd_gpu_xgmi_nbr_5_tx_thrput":    `amd_gpu_xgmi_nbr_5_tx_thrput{$1}`,
	"node_amd_pcie_max_speed":              `amd_pcie_max_speed{$1}`,
	"node_amd_pcie_speed":                  `amd_pcie_speed{$1}`,
